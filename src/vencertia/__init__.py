"""Vencertia Adaptive Decision System v2.0.1.

A calibration-first decision runtime for high-uncertainty venture decisions,
extended with the full idea → decision → business-plan path (v2.0):
...
Four layers:
  ...
  SKILLS                 — versioned experience assets (V11 prompt migration), candidates only
"""
