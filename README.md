...
make test             # pytest（559 passed / 1 skipped）—— v1.5.0 最终回归（重构级：引擎 DRY 收敛 + presentation 归位，零行为变更）
...
> 测试数字为 v1.5.0 最后一次干净回归（1 skipped 为 PostgreSQL parity，本机无 PG 由 CI 兑现）；历史数字对照见
> `docs/baseline-v1-0.md`（v1.0 174 / v1.1-pre-RC 283 / v1.1-RC 345 / v1.1.2 417 / v1.2 483 / v1.2.1 506 / v1.3.0 532 / v1.4.0 559 / v1.5.0 559，各状态不混数字）。
